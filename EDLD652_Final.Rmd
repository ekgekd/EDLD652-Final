...
#just seeing what a log axis looks like here! Not very interesting at all...
    scale_x_log10() +
  theme_minimal() +
  theme(
...
# possibility: would creating a vector like ageranges = c("<15","15-19",etc...) and sorting into there be an option? 
