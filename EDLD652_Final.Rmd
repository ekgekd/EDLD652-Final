...
#MVC Peer review suggestion. Perhaps a way to show this is to facet wrap 
# age group and then highlight similarities differences? I added here an 
# example but this isn't order right, but just an idea how it could be like
  ggplot(tidy,aes(n, reorder(word,n), group_by(agegroup))) +
  geom_col(fill = "cornflowerblue") +
  scale_x_continuous(expand = c(0,0)) +
  facet_wrap(~agegroup) +
  theme_minimal() +
...
# MVC PEER REVIEW: I added the reorder to your aes to help reorder your variables
  ggplot(middle, aes(n_20s, reorder(twenties, n_20s))) +
...
# MVC PEER REVIEW: I added the reorder to your aes to help reorder your variables
  ggplot(oldest, aes(n_over30, reorder(over_30,n_over30))) +
